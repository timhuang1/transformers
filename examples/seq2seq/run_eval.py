...
def run_generate(verbose=True):
    ...
    parser.add_argument(
        "--n_obs", type=int, default=-1, required=False, help="How many observations (i.e., examples) used for evaluation. Defaults to all."
    )
    ...
    # to read all examples from val.source into this list 
